...
\begin{center}
    \textbf{\Huge \scshape Vivek Parashar} \\ \vspace{2pt}
    \small +91-9884916300 $|$ \href{mailto:vivekparashar811@gmail.com}{\underline{vivekparashar811@gmail.com}} $|$ 
    \href{https://vivek1052.github.io/}{\underline{https://vivek1052.github.io}}  $|$ \href{https://www.linkedin.com/in/vivek-parashar-a525a469}{\underline{linkedin.com/in/vivek-parashar-a525a469}} \\ \vspace{2pt}
    \small Bengaluru, KA, India-560037
\end{center}

%-----------Summary--------------
\section{Summary}
  \small{Full-stack Cloud Native Software Engineer with 8 years of experience, ranging from building SaaS ERPs to distributed systems and web services.}
...
%-------------------------------------------
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Gained experience deploying containerized applications using Jenkins CI/CD pipelines. Learned about object-oriented design patterns and their use within enterprise-grade framework architecture.}
    \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Mentored interns on project codebase. Collaborated with business for requirement gathering. }
    \resumeItemListEnd
